...
const textCopy = contentText.repeat(8);
...
const tabConts = document.querySelectorAll(".tab_cont .pro_cont");
...
tabBtns.forEach((btn, i) => {
  btn.addEventListener("click", (e) => {
    ...
    tabConts.forEach((otherConts) => {
      otherConts.classList.add("hide");
    });

    tabBtns[i].classList.add("active");
    tabConts[i].classList.remove("hide");
  });
});
